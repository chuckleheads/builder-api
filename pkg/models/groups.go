...
type Group struct {
	...
	GroupState  null.String `boil:"group_state" json:"group_state,omitempty" toml:"group_state" yaml:"group_state,omitempty"`
...
var GroupWhere = struct {
	ID          whereHelperint64
	GroupState  whereHelpernull_String
	...
	GroupState:  whereHelpernull_String{field: `group_state`},
...
var (
	groupColumns               = []string{"id", "group_state", "project_name", "created_at", "updated_at", "target"}
	groupColumnsWithoutDefault = []string{"group_state", "project_name"}
	groupColumnsWithDefault    = []string{"id", "created_at", "updated_at", "target"}
