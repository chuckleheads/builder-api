...
var (
	groupDBTypes = map[string]string{`ID`: `bigint`, `GroupState`: `text`, `ProjectName`: `text`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `Target`: `text`}
	_            = bytes.MinRead
)
